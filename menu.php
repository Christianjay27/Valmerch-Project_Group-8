...
<html>
    ...
    <center>
      ...
      VALORANT MERCHANDISE<br>
      
	  	<h2>Our product are ID Lace, T-shirt, Hoodie and Mouse Pad</h2> 
	    </div>
	  </center>
              ...
              if(productsAll[i].cafeid==(i+1)||i==((productsAll[i].cafeid-1)*3)){
                ...
                output+="<div class=\"product-card\" style=\"position:relative;\"><span class=\"status\" style=\"position:absolute; top:0px; left:0px;\" >  </span>"
                          ...
                          +"<div class=\"product-info\">"
                            +"<h3 style=\"color:#FFD6BA\">"+productsAll[i].prod_name+"</h3>"
                            +"<form class=\"frm\">"
                              ...
                              +"<p style=\"color:#FFD6BA\"><strong>Quantity</strong></p>"
                            +"</form>"
                            ...
                            +"<br><br>"
                            +"<div class=\"card1\">"
                              +"<p style=\"color:#FFD6BA\"><button class=\"addthis\" data-name=\""+productsAll[i].prod_name+"\" data-cafepic=\""+productsAll[i].cafepic+"\" data-cafeid=\""+productsAll[i].cafeid+"\"><strong><img src=\"images/cart.png\" class=\"asd\"><strong>&nbsp;ADD TO CART</strong></strong></button></p>"
                            +"</div>"
                          +"</div>"
                        +"</div>"
                  }
