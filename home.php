...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>VALMERCH | Ecommerce Website</title>
 ...
 <!-- <?php if(isset($_SESSION['userlogin'])){if($_SESSION['userlogin']['userid']=="admin"){include 'navbarAdmin.php';} else{include 'navbar.php';}}else{include 'navbar.php';} ?> -->
  ...
  <body>
    ...
    <header>
      <img src="logoFillPink.png" width="175px">
      <div class="menu-btn"></div>
      <div class="navigation">
        <div class="navigation-items">
          <a href="index.php">Home</a>
          <a href="menu.php">Products</a>
          <a href="aboutdevs.php">About</a>
    ...
    <section class="home">
      ...
      <video class="video-slide" src="images/slidepart2.mp4" autoplay muted loop></video>
      <video class="video-slide" src="images/resizedpart3.mp4" autoplay muted loop></video>

      <div class="content active">
        <h1>Spice Your Outfit<br><span>With A Gamer Style</span></h1>
        <p>Valorant is a free-to-play-first-person hero shooter 
          <br>developed and published by Riot Games.
      </p>
