        ...
        <div class="container-fluid">
          ...
          <ol class="carousel-indicators">
            ...
            <div class="carousel-inner">
              ...
              <video class="video-slide active" src="images/FinalAdjust.mp4"autoplay muted loop> </video>
              
                 <div class="carousel-caption d-none d-md-block">
                  <h1 class="imgLog1">Spice Your Outfit<br> With A Gamer Style</h1><br><br>
                   <h4 class="imglogdes"><p>Valorant is a free-to-play-first-person hero shooter <br> developed and published by riot games</p></h4>
                   <br><br><button  onclick="location.href = 'menu.php';" class="btn buyColor btn-lg rounded-pill imgLog1but">Buy Now!</button>
                 </div>
                 
              </div>
              <div class="carousel-item">
              <video class="video-slide active" src="images/slidepart2.mp4"autoplay muted loop alt="img1"> </video>
              ...
              <div class="carousel-item">
              <video class="video-slide active" src="images/resizedpart3.mp4"autoplay muted loop alt="img1"> </video>
